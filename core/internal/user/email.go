...
func SendDailySnapEmail(toEmails []string, stories []models.ShortStory) {
	...
	for index := range numberOfStories {
		didItSaveImage[index] = saveStoryImage(stories[index], index)
	}
...
func buildDailySnapEmail(stories []models.ShortStory, didItSaveImage []bool, numberOfStories int) gomail.Message {
 ...
 <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <div style="font-size:1px;line-height:5px"> </div><a href="%2" style="outline:none" tabindex="-1" target="_blank"><img align="center" alt="Company Logo" border="0" class="center fixedwidth" src="cid:truba_logo.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 550px; max-width: 100%; display: block;" title="Company Logo" width="550"/></a>
...
func saveStoryImage(currentStory models.ShortStory, index int) bool {
...
func shortStoryToHTML(currentStory models.ShortStory, index int, didItSave []bool) string {
	...
	return fmt.Sprintf(`
		"""\
    <a href="%[1]d" rel="noopener" style="text-decoration: none;" target="_blank">
    <table border="0" cellpadding="0" cellspacing="0" class="divider" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;" valign="top" width="100%">
    <tbody>
    <tr style="vertical-align: top;" valign="top">
    <td class="divider_inner" style="word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;" valign="top">
    ...
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 20px;padding-left: 20px;" align="center"><![endif]--><img align="center" border="0" class="center fixedwidth fullwidthOnMobile" src="cid:%[2]d" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 560px; max-width: 100%; display: block;" title="News Article Image" width="560"/>
    <!--[if mso]></td></tr></table><![endif]-->
    </div>
    ...
    <p style="margin: 0; font-size: 26px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 31px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 26px;">%[3]d</span></p>
    <p style="margin: 0; font-size: 18px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 31px; margin-top: 10px; margin-bottom: 0;"><span style="font-size: 18px;">%[4]d</span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    </a>
