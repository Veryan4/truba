...
class FeedbackEmojiComponent extends LitElement {
          ...
          <ul class="feedback">
            <lit-spa-tooltip text="${this.i18n.t("home:angry")}" position="top">
              <li
                ...
                @click="${(e: Event) =>
                  this.onFeedbackClick(FeedbackType.angry, true)}"
              >
                <div>
                  <svg class="eye left">
            ...
            <lit-spa-tooltip text="${this.i18n.t("home:sad")}" position="top">
              <li
                ...
                @click="${(e: Event) =>
                  this.onFeedbackClick(FeedbackType.cry, true)}"
              >
                <div>
                  <svg class="eye left">
                    <use xlink:href="#eye"></use>
            ...
            <lit-spa-tooltip text="${this.i18n.t("home:ok")}" position="top">
              <li
                ...
                @click="${(e: Event) =>
                  this.onFeedbackClick(FeedbackType.neutral, true)}"
              >
                <div></div>
              </li>
            </lit-spa-tooltip>
            <lit-spa-tooltip text="${this.i18n.t("home:smile")}" position="top">
              <li
                ...
                @click="${(e: Event) =>
                  this.onFeedbackClick(FeedbackType.smile, true)}"
              >
                <div>
                  <svg class="eye left">
                    <use xlink:href="#eye"></use>
            ...
            >
              <li
                ...
                @click="${(e: Event) =>
                  this.onFeedbackClick(FeedbackType.happy, true)}"
              >
                <div>
                  <svg class="eye left">
                    <use xlink:href="#eye"></use>
  ...
  onFeedbackClick(feedbackType: FeedbackType, isEmoji = false) {
    ...
    if (isEmoji) {
      ...
      newsService
        .getSingleArticle(
          userService.state.getValue(),
          this.story_id,
          this.source_id,
        )
        .then(() => articleEl.classList.remove("active"));
    }
  }
}
